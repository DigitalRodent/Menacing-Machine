# # 2026-05-28  
- I have begun the Gantt chart and filled out each task.
- Coding will commence when the paperwork is done.    
- Used a free Gantt chart template provided with a bunch of useful cells.  

# # 2026-06-02
- We gave Jon a bond of $20 to have the maqueen.
- We begun work on the line following. 
- I made a track with some A3 sheets and duct tape for lines, and developed a track to test the bots following capabilities.
